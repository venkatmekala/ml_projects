...
def search_and_download(search_term: str, target_path='./static', number_images=5):
    ...
    # heroku chrome drive initialization starts
...
def searchImages():
    ...
    # number_images = 10
    #search_and_download(search_term=keyWord, driver_path=driver)  # method to download images
    search_and_download(search_term=keyWord)  # method to download images
